[![Mitsui's GitHub stats](https://github-stats-extended.vercel.app/api?username=YanJieWen)](https://github.com/stats-organization/github-stats-extended)
...
- Crowd Situational Awareness
- Transportation Big Data Mining
- Train Crashworthiness
### 🚡Low-Altitude Economy (LAE)
- UAV-based Intelligent Sensing
- AI-enabled Airspace Perception
- Low-altitude Economy Scenes
## 🧭 Academic Affiliations
I currently serve as a reviewer for several international journals:
- [IEEE Transactions on Image Processing](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=83)
- [IEEE Transactions on Circuits and Systems for Video Technology](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=76&year=1995)
